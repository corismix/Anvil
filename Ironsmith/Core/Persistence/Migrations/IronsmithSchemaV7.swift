...
enum IronsmithSchemaV7: VersionedSchema {
    ...
    final class Tool {
        ...
        init(
            ...
            self.bundleIdentifier =
                bundleIdentifier ?? ToolBundleIdentifier.make(executableName: resolvedExecutableName)
    ...
    final class ProviderConfig {
        ...
        var isEnabled: Bool
        var openAICompatibleAPIVariant: OpenAICompatibleAPIVariant = OpenAICompatibleAPIVariant
            .chatCompletions
