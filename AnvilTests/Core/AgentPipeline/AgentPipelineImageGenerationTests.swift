...
extension AgentPipelineTests {
    ...
    func hostedIconPromptLocksHouseStyleButPlaygroundKeepsCompactConcept() {
        ...
        #expect(hostedPrompt.contains("exact Anvil house style"))
        ...
        #expect(hostedPrompt.contains("Anvil applies the final app-icon shape separately"))
    ...
    func hostedIconPaletteExcludesTenRecentSelectionsAcrossStoreInstances() async {
        let suiteName = "AnvilTests.HostedIconPalette.\(UUID().uuidString)"
        ...
        #expect(
            userDefaults.array(forKey: AnvilPreferenceKeys.recentHostedIconPaletteIndices)?.count
